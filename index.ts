...
// A QUIZ TO KNOW IF YOU'RE AN INTROVERT OR NOT!
console.log(
  chalk.white.bold("\t ARE YOU AN INTROVERT? TAKE THE QUIZ TO KNOW! \n")
);
console.log(
  chalk.blue("\t If you get atleast 3 questions right, YOU'RE AN INTROVERT! \n")
);
let quiz: {
  question1: string;
  question2: string;
...
} = await inquirer.prompt([
  {
    ...
    choices: ["Energized for awhile", "Exhausted", "Like I'm alive!"],
  },
  {
    name: "question2",
    type: "list",
  ...
  },
  {
    ...
    type: "list",
    message: chalk.yellow.italic(
      "When I'm dealing with a personal problem, I prefer to..."
    ),
    choices: [
      "Solve it on my own!",
